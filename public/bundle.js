...
render(siteMainElement, Object(_view_stats_js__WEBPACK_IMPORTED_MODULE_1__["createStatsTemplate"])(), `beforeend`);
...
filmListExtra.forEach(element => {for (let i = 0; i < CARDS_IN_BLOCK_COUNT; i++) {
