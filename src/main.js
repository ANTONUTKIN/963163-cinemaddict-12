...
const CARDS_COUNT = 5;
const BLOCKS_COUNT = 2;
const CARDS_IN_BLOCK_COUNT = 2;

// Шаблон рейтинга пользователя
...
// Шаблон контейнера карточек фильма
...
// Шаблон попапа подробной информации
...
const filmElement = siteMainElement.querySelector(`.film`);
render(filmList, createTopRatedContainerTemplate(), `beforeend`);
render(filmList, createMostCommentedContainerTemplate(), `beforeend`);

// Вставляем карточки фильмов в контейнеры Top rated и Mos commented
